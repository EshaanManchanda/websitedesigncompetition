...
const sendRegistrationEmails = async (registrationData) => {
  ...
  const templateData = {
    ...
    paymentScreenshotUrl: toAbsoluteUrl(registrationData.paymentScreenshotUrl),
    paymentScreenshotName: registrationData.paymentScreenshotName || null,
    paymentScreenshotSize: registrationData.paymentScreenshotSize ? formatFileSize(registrationData.paymentScreenshotSize) : null,
    paymentScreenshotType: registrationData.paymentScreenshotType || null,
    paymentUploadedAt: registrationData.paymentUploadedAt ? formatEmailDate(registrationData.paymentUploadedAt) : null,
